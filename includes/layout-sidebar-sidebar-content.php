...
add_filter( 'ldm-classes-to-add', 'ldm_sidebar_sidebar_content_classes', 10, 3 );
function ldm_sidebar_sidebar_content_classes( $classes_to_add, $context, $attr ){
...
add_action( 'genesis_before', 'ldm_sidebar_sidebar_content_markup_mod', 15 );
